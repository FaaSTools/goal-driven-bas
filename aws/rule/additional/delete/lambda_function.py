...
def delete_rule_in_db(ruleId):
    payload = {
        'ruleId': ruleId
    }
    response = lambda_client.invoke(
        FunctionName='DELETE_RULE_IN_DB_LAMBDA_ARN', # Replace with the ARN of the Delete Rule in DB Lambda
...
def lambda_handler(event, context):
    ...
    response = delete_rule_in_db(body['ruleId'])
